<template>
  <div class="container-fluid ">
    <h1 class="">Total Products</h1>
    <div v-if="cartCount === 0" class="alert alert text-white " style="background-color: chocolate;" role="alert">
      Your cart is empty
    </div>
    <div v-else>
      <section class="">
        <div class="container  px-lg-5 ">
          ...
          >
            <div class="col" v-for="product in cart" :key="product.id">
              <div class="card h-100">
                ...
                <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                  <div class="text-center">
                    <button
                      class="btn btn mt-auto" style="background-color: chocolate; color: aliceblue;"
