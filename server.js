...
MongoClient.connect("mongodb+srv://nailabaloch111:1234naila@cluster0.sxvblhl.mongodb.net/", (err, client) => {
    if (err) {
        console.error('Error connecting to the database:', err);
    } else {
        const db = client.db('db_cw2');
        ...
        app.post('/collection/orders', (req, res) => {
            ...
            const ordersCollection = client.db(db_cw2).collection('order');
